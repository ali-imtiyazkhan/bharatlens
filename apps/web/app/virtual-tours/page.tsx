  ...
  return (
    <div className="page">
      ...
      <div style={{ padding: '80px 32px', flex: 1, display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <span className="section-label">IMMERSIVE 3D EXPERIENCES</span>
        ...
        <p style={{ color: 'rgba(255,255,255,0.5)', maxWidth: 600, lineHeight: 1.8, fontSize: 13 }}>
          This page is currently under construction. Soon you'll explore India's most iconic 
          heritage sites in immersive 3D — from Hampi to Konark, right from your browser.
        </p>
